...
import difflib
import os
import psutil  # 🚀 Fast process management
...
# --- 2. FAST PROCESS FETCH USING PSUTIL (No subprocess) ---
...
def close_any_app(apps_to_close):
    ...
    # Refresh active process list once per call (now super fast with psutil)
